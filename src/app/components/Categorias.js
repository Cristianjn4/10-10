        ...
        <div className=" w-full h-auto bg-gradient-to-b bg-white align justify-center py-11 gap-8">
            ...
            <div className="w-2/3 h-auto  md:flex lg:flex align m-auto gap-8 text-center ">
                <div className="bg-transparent w-40 rounded-full m-auto py-3">
                    ...
                    <br/>
                    <a className=" b-3 font-normal text-black text-center w-auto"> Colchões </a>
                </div>

                <div className="bg-transparent w-40 rounded-full m-auto py-4">
                    <a href="/products#camas">
                    <img src="camas.png" alt="" className="bg-white w-40 h-40 rounded-full shadow-lg border-2 border-transparent hover:border-blue-600" />
                    </a>
                    <br/>
                ...
                <div className="bg-transparent w-40 rounded-full m-auto py-4">
                    ...
                    <img src="sistdesc.png" alt="" className="bg-white w-40 h-40 rounded-full shadow-lg border-2 border-transparent hover:border-blue-600" />
                    </a>
                    <a href="" className="  font-normal text-black text-center w-auto "> Sistemas de Descanso </a>
                </div>
