    ...
    return(
        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 pt-28">
          <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            ...
            {/* Orbhes Logo */}
                <img src="https://orbhes.com.br/wsite/br/img/logo.png" alt="Orbhes" class="w-40 block md:float-right"/>
              
            {/* colchao foto */}
            
            <div className="text-white bg-stone-900 rounded-lg w-auto m-4 px-3 absolute text-center"> Frete Grátis </div>
              <img class="w-full" src="http://orbhes.com.br/wsite/_upl/produtos/bff5a4339d4f75dec57a3efe25cc3fff.png" alt="" />             
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            {/* colchao nome */}
              ...
              <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                <a
                  href="http://orbhes.com.br/wsite/_upl/produtos/bff5a4339d4f75dec57a3efe25cc3fff.png"
                  target="blank"
                  title=""
                ...
                <a
                  href="https://orbhes.com.br/colchao-detalhes_pdf?cod=94512583452"
                  target="blank"
                  title=""
...
Utiliza o molejo Ensacado Rolled Core, com 20cm de altura.   
