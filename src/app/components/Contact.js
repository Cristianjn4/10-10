    ...
    return(
        ...
        <h2 class="mb-4 text-4xl tracking-tight font-bold text-center text-gray-900 dark:text-black mt-10">Fale Conosco</h2>
            ...
            <div className="w-auto h-auto m-auto gap bg-white rounded-2xl justify-between">
                            ...
                            <a
                            href="https://api.whatsapp.com/send/?phone=5511995379301&text=Ol%C3%A1%2C+gostaria+de+realizar+a+cota%C3%A7%C3%A3o+de+um+colch%C3%A3o+Restonic.&type=phone_number&app_absent=0" target="blank"
