export default function Footer() {
    return(
        <footer className="bg-[#4E6282] bottom-0">
                ...
                <div className=" grid-cols-3 gap-10 grid">
                    ...
                    <div className="hidden lg:block">
                        ...
                        <ul className="text-white font-light ">
                            ...
                            target="blank" className="hover:underline">Loja de colchão em Jundiaí/ SP - Restonic  <br></br> Rua do Retiro, 1800</a>
                            </li>
                            ...
                            <li>
                                ...
                                target="blank" className="hover:underline">Loja de colchão em Itatiba/ SP - Restonic <br></br> Rua Luiz Scavone, 511</a>
                            </li>
                        </ul>
            ...
            <hr className="mx-10 border-stone-200 sm:mx-auto  lg:my-8" />
            ...
            <div className="bg-[#262223] p-3 sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex mt-4 mr-24 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://www.facebook.com/simmons.casaorner" target="blank" className="text-white hover:text-stone-900 ">
                    ...
                    <a href="https://www.instagram.com/simmons.casaorner" target="blank" className="text-white hover:text-stone-900  ms-5">
                    ...
                    <a href="https://www.youtube.com/@casaorner2636" target="blank" className="text-white hover:text-stone-900 
                     ms-5">
