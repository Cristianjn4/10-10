    ...
    <div id="popup-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative rounded-lg shadow w-auto">
                <iframe width="520" height="315" src="https://www.youtube.com/embed/08S4lureMlM" title="Como um Colchão de Látex é Produzido" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
        </div>
    </div>
            ...
            {/* colchao nome */}
              ...
              <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                <a
                  href="https://kingpedic.com.br/wsite/_upl/produtos/b860676eec1e281442430676fb12ccb6.jpg"
                  target="blank"
                  title=""
                ...
                <a
                  href="https://kingpedic.com.br/colchao-detalhes_pdf?cod=90443583254"
                  target="blank"
                  title=""
...
<button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-black bg-white hover:bg-black hover:text-white border-2 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center " type="button">Medidas <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
    ...
    <p>
        ...
        Colchão de suporte medium, produzido com molejo de Fio Contínuo Não Entrelaçado Posture Spiral®, o máximo em suporte entre todos os molejos.
Em seu matelassê, utiliza-se Látex para maior conforto.
Nossos colchões recebem tratamento de retardo a chama para maior segurança.
.
