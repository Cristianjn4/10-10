export function HighcomfortItemh() {
    return(
    ...
    <div id="popup-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative rounded-lg shadow w-auto">
                <iframe width="520" height="315" src="https://www.youtube.com/embed/pQl8AvQhUEc" title="ESPUMA  ANTICHAMA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
        </div>
    </div>
            ...
            <div class="mt-6 sm:mt-8 lg:mt-0">
              ...
              <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                ...
                <a
                  href="https://kingpedic.com.br/colchao-detalhes_pdf?cod=94555583254"
                  target="blank"
                  title=""
              ...
              <div className=" mt-6 gap-2 text-sm text-black">
                <p class="font-semibold">Altura: 32cm</p>
...
<button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-black bg-white hover:bg-black hover:text-white border-2 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center " type="button">Medidas <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
    ...
    <p>
        ...
        Individualmente de grande suporte e estabilidade, com 20cm de altura.
        Espuma Viscoelástica junto ao tecido malha para um conforto especial.
        Nossos produtos possuem tratamento de retardo a chama para maior segurança.
