        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 pt-28">
          <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            ...
            <div className="text-white bg-stone-900 rounded-lg w-auto m-4 px-3 absolute text-center"> Frete Grátis </div>
              <img class="w-full" src="https://www.colchaostallion.com.br/wp-content/uploads/2021/12/8F2FDC4F-7429-4496-9741-2AB973E99A68.png" alt="" />             
...
<button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-black bg-white hover:bg-black hover:text-white border-2 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center " type="button">Medidas <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
    ...
    <p>O Stallion Hackney é o colchão com fibras naturais mais macio de toda a linha Stallion.

Com cerca de 12 cm do mais puro látex Pulse, propicia um conforto excepcional.

Seu tecido, isento de enchimento de poliéster, traz conforto e beleza únicos

Produto certificado de acordo com a Portaria Inmetro: 75/2021
        <br/>
    ...
    MALHA 200 g/m2 51% POLIESTER 49% VISCOSE MICRO TENCEL
    <br/>
    Proteção Active Biotic - Pro Bioticos
        <br/>
